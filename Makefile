...
ioscli:
	$(CC) -isysroot /var/sdks/Latest.sdk -DRRRR_TDATA_IO_MMAP -DRRRR_BITSET_64 -DNDEBUG -O2 -Wextra -Wall -std=c99 -lm -o cli router.c tdata.c tdata_validation.c bitset.c router_request.c router_result.c util.c tdata_io_v4_mmap.c radixtree.c geometry.c hashgrid.c cli.c plan_render_text.c api.c set.c string_pool.c hashgrid_streetnetwork.c street_network.c

ios:
	$(CC) -isysroot /var/sdks/Latest.sdk -DRRRR_TDATA_IO_MMAP -DRRRR_BITSET_64 -DNDEBUG -O2 -Wextra -Wall -std=c99 -c router.c tdata.c tdata_validation.c bitset.c router_request.c router_result.c util.c tdata_io_v4_mmap.c radixtree.c geometry.c hashgrid.c api.c set.c string_pool.c hashgrid_streetnetwork.c
	libtool -static -o ../librrrr.a router.o tdata.o tdata_validation.o bitset.o router_request.o router_result.o util.o tdata_io_v4_mmap.o radixtree.o geometry.o hashgrid.o api.o set.o string_pool.o hashgrid_streetnetwork.o street_network.o
...
all:
	...
	$(CC) -c -Wextra -Wall -ansi -pedantic hashgrid_streetnetwork.c
	...
	$(CC) -lm -lprotobuf-c -o cli -Wextra -Wall -ansi -pedantic cli.c router.c tdata.c tdata_validation.c bitset.c router_request.c street_network.c hashgrid_streetnetwork.c router_result.c util.c tdata_realtime_alerts.c tdata_realtime_expanded.c tdata_io_v4_dynamic.c radixtree.c gtfs-realtime.pb-c.c geometry.c hashgrid.c plan_render_text.c polyline.c api.c set.c string_pool.c
