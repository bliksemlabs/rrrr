...
static const ProtobufCFieldDescriptor osmpbf__header_block__field_descriptors[8] =
{
  ...
  },
  {
    ...
    PROTOBUF_C_OFFSETOF(OSMPBF__HeaderBlock, has_osmosis_replication_timestamp),
    PROTOBUF_C_OFFSETOF(OSMPBF__HeaderBlock, osmosis_replication_timestamp),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_INT64,
    PROTOBUF_C_OFFSETOF(OSMPBF__HeaderBlock, has_osmosis_replication_sequence_number),
    PROTOBUF_C_OFFSETOF(OSMPBF__HeaderBlock, osmosis_replication_sequence_number),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_TYPE_STRING,
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(OSMPBF__HeaderBlock, osmosis_replication_base_url),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
