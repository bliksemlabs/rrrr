...
class TestSequenceFunctions(unittest.TestCase):
    ...
    def test_integration(self):
        ...
        conn = Connection(tdata,'SP1','SP2',3,type=2)
        conn = Connection(tdata,'SP2','SP1',3,type=2)
        conn = Connection(tdata,'SP3','SP2',3,type=2)
        conn = Connection(tdata,'SP2','SP3',3,type=2)
